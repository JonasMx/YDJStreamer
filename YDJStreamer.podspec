#
#  Be sure to run `pod spec lint YDJStreamer.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.source       = { :git => "https://github.com/JonasMx/YDJStreamer.git", :tag => "#{s.version}" }
#  s.source       = { :path => '.' }
